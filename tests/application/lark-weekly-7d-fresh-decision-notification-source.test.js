  ...
  const seed = {
    fields: {
      ...
      channel_status_vector_json: JSON.stringify([
        { channelKey: 'tiktok_organic', readinessStatus: 'report_missing' },
        { channelKey: 'facebook_organic', readinessStatus: 'report_missing' },
        { channelKey: 'instagram_organic', readinessStatus: 'report_missing' },
        { channelKey: 'youtube_organic', readinessStatus: 'report_missing' },
        { channelKey: 'meta_ads', readinessStatus: 'report_available' },
        { channelKey: 'google_ads', readinessStatus: 'report_available' },
        { channelKey: 'tiktok_ads', readinessStatus: 'report_missing' },
        { channelKey: 'woocommerce', readinessStatus: 'report_missing' },
        { channelKey: 'chatwoot', readinessStatus: 'report_missing' },
      ]),
