...
test('read-only Notification admission preview reports mixed state without mutating it', () => {
...
test('recovery restores retained per-row baseline without resend, deploy, or unsafe reactivation', () => {
