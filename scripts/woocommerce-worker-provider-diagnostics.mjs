...
async function verifyPreviewVersionAndProbe(input) {
  ...
  return Object.freeze({
    ...
    aliasedPreviewUrlCount: input.upload.aliasedPreviewUrlCount,
    versionedPreviewUrlCount: input.upload.versionedPreviewUrlCount,
    distinctAliasedPreviewUrlCount: input.upload.distinctAliasedPreviewUrlCount,
    distinctVersionedPreviewUrlCount: input.upload.distinctVersionedPreviewUrlCount,
