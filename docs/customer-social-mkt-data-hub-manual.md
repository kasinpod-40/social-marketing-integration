...
ตัวเลขบน Dashboard มาจากรายงานที่ระบบคำนวณและตรวจความครบถ้วนแล้ว ผู้ใช้กรองข้อมูลตาม Platform, Account และช่วงเวลา `1D`, `3D`, `7D` หรือ `30D` ได้ หากข้อมูลฐานสำหรับเปรียบเทียบยังไม่ครบ ช่องนั้นจะแสดงเป็นช่องว่างหรือ `N/A` โดยไม่ใช้เลขศูนย์แทนข้อมูลที่ขาด
