...
export const JOB_TYPES = Object.freeze({
  ...
  CUSTOMER_TIKTOK_LARK_SNAPSHOT_IMPORT: 'lark.customer-tiktok.snapshot.import',
...
export const JOB_TRIGGERS = Object.freeze({
  ...
  CUSTOMER_TIKTOK_SNAPSHOT_IMPORT: 'customer_tiktok_snapshot_import',
...
const JOB_CATALOG = Object.freeze({
  ...
  [JOB_TYPES.CUSTOMER_META_K2_LARK_SNAPSHOT_IMPORT]: freezeJob({
    type: JOB_TYPES.CUSTOMER_META_K2_LARK_SNAPSHOT_IMPORT,
    implementationStatus: JOB_IMPLEMENTATION_STATUS.ACTIVE,
    connectorKey: null,
    manualOnly: true,
    allowedTriggers: [JOB_TRIGGERS.CUSTOMER_META_K2_SNAPSHOT_IMPORT],
  }),
  [JOB_TYPES.CUSTOMER_D1_LARK_SNAPSHOT_IMPORT]: freezeJob({
    type: JOB_TYPES.CUSTOMER_D1_LARK_SNAPSHOT_IMPORT,
    implementationStatus: JOB_IMPLEMENTATION_STATUS.ACTIVE,
    connectorKey: null,
    manualOnly: true,
    allowedTriggers: [JOB_TRIGGERS.CUSTOMER_D1_SNAPSHOT_IMPORT],
  }),
  [JOB_TYPES.CUSTOMER_TIKTOK_LARK_SNAPSHOT_IMPORT]: freezeJob({
    type: JOB_TYPES.CUSTOMER_TIKTOK_LARK_SNAPSHOT_IMPORT,
    implementationStatus: JOB_IMPLEMENTATION_STATUS.ACTIVE,
    connectorKey: null,
    manualOnly: true,
    allowedTriggers: [JOB_TRIGGERS.CUSTOMER_TIKTOK_SNAPSHOT_IMPORT],
  }),
