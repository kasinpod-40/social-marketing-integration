...
const DEFAULT_CONVERSATION_ROWS_PER_INVOCATION = 1;
...
export function readChatwootRuntimeConfig(env = {}) {
  ...
  return Object.freeze({
    ...
    limits: Object.freeze({
      ...
      conversationRowsPerInvocation: readInteger(
        env.CHATWOOT_CONVERSATION_ROWS_PER_INVOCATION,
        'CHATWOOT_CONVERSATION_ROWS_PER_INVOCATION',
        1,
        25,
        DEFAULT_CONVERSATION_ROWS_PER_INVOCATION,
      ),
