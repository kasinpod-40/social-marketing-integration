 ...
 */
export const LARK_REPORT_MATERIALIZATION_SCHEMA_VERSION = 'report-materialization-schema-v2';
  ...
  tables: {
    ...
    mktReportTopAds: {
      ...
      fields: [
        ...
        text('customer_profile'), select('report_type', ['dashboard_performance_report']),
        ...
        number('roas'), select('data_status', DATA_STATUS_OPTIONS), dateTime('period_start'),
...
function number(fieldName) { return { fieldName, type: 2, uiType: 'Number', primary: false }; }
