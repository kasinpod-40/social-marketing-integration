...
[`ไฟล์ Word`](docs/คู่มือ-Social-MKT-Data-Hub.docx)
...
PR #880 เปิดใช้งานงานนี้บน Production แล้ว; รอบตรวจจริงวันที่ 25 ก.ย. 2026 ลบแถวเก่าที่พิสูจน์กับ D1
ได้ 500 แถวและปิดเหตุขัดข้องเดิม งานตามตารางเวลาจะทยอยจัดการแถวเก่าที่เหลือตามเพดานต่อรอบ.
